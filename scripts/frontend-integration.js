 ...
 * This file demonstrates how to integrate Novawane with a web frontend
 */

// For React/Vue/Angular applications
export class NovawaneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NovawaneClient(provider, contractAddress);
